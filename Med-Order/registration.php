...
<div style="background-image: url('images/img/reg.jpg'); background-size: cover;">

        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    <button class="navbar-toggler hidden-lg-up" type="button" data-toggle="collapse" data-target="#mainNavbarCollapse">&#9776;</button>
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/logo.png" alt="" height="38px" width="260px"> </a>
                            ...
                            <div class="widget">
                                <div class="widget-body">
                                    ...
                                    <form action="" method="post">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <p> <input type="submit" value="Register" name="submit" class="btn theme-btn" style="background-color:#1CD590;border: none;width: 150px;"> </p>
                                            </div>
                                        </div>
                                    </form>
