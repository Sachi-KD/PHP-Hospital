...
<div class="card card-outline">
	<div class="card-header">
		<h3 class="card-title" style="font-weight: bold;">List of Medicine</h3>
		<div class="card-tools">
			<a href="?page=product/manage_product" class="btn btn-flat btn-primary" style="background-color: #00d9a5; border-color: #00d9a5; color: black;"><span class="fas fa-plus"></span>  Create New</a>
		</div>
	</div>
	<div class="card-body">
