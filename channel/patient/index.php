            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-session">
                        <a href="schedule.php" class="non-style-link-menu"><div><p class="menu-text">Scheduled Channel</p></div></a>
                    </td>
                </tr>
                <tr class="menu-row" >
        ...
        <div class="dash-body" style="margin-top: 15px">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                        ...
                        <tr >
                            ...
                            <image src="../img/logo.png" height="40px" width="290px" style="margin-right:6px; margin-left:28px; margin-top:8px;margin-bottom:12px;">
                            </a>
                ...
                <tr>
                    ...
                    <center>
                    <table class="filter-container doctor-header patient-header" style="border: none;width:95%;height: 200px;" >
                    <tr>
                        <td >
