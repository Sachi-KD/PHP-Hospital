            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td>
                                <p style="padding: 0;margin: 0;text-align:center;font-size: 25px;font-weight: 500;">View User Details</p><br><br>
                                </td>
                            </tr>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td style="text-align: center;">
                                            <p style="padding: 0;margin: 0;text-align: center;font-size: 25px;font-weight: 500;">Edit User Account Details.</p>
                                        User ID : '.$id.'<br><br>
                                        </td>
                                    </tr>
                                    <tr>
