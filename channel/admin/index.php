    ...
    <div class="container">
        ...
        <div class="dash-body" style="margin-top: 15px">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                            ...
                            <image src="../img/logo.png" height="40px" width="290px" style="margin-right:6px; margin-left:58px; margin-top:8px;margin-bottom:5px;">
                            </a>
                ...
                <tr>
                    <td colspan="4">
                        <table width="100%" border="0" class="dashbord-tables">
                            <tr>
                                <td>
                                    <p style="padding:10px;padding-left:48px;padding-bottom:0;font-size:23px;font-weight:500;color:var(--primarycolor);">
                                    ...
                                    <p style="padding-bottom:19px;padding-left:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                                        ...
                                        For Further Details check Appointment section.
                                    </p>

                                </td>
                                <td>
                                    <p style="text-align:right;padding:10px;padding-right:48px;padding-bottom:0;font-size:23px;font-weight:500;color:var(--primarycolor);">
