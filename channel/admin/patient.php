                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <br><br><br><br>
                                    <center>
                                    <img src="../img/notfound.png" width="5%">
                ...
                <div id="popup1" class="overlay">
                        ...
                        <center>
                            ...
                            <tr>
                                ...
                                <tr>
                                    <td class="label-td" colspan="2">
                                        <form action="edit-pat.php" method="POST" class="add-new-form">
                                        <label for="Email" class="form-label">Email </label>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="dob" class="input-text" placeholder="Date of Birth" value="'.$dob.'" required><br>
                                </td>
                            </tr>
                            <tr>
