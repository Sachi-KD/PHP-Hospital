                        ...
                        <table border="0" class="profile-container">
                            <tr>
                                <td width="30%" style="padding-left:20px" >
                                    <img src="../img/user.png" alt="" width="70%" style="border-radius:50%">
                                </td>
                                ...
                                <td style="width: 25%;">
                                    ...
                                    <div  class="dashboard-items setting-tabs"  style="padding:20px;margin:auto;width:95%;display: flex">
                                        ...
                                        <div>
                                                ...
                                                <div class="h3-dashboard" style="font-size: 15px; color: gray;">
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    <div class="popup">
                    <center>
                        <h2 style="font-weight: 500px;">Are you sure?</h2>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <a class="close" href="settings.php">&times;</a>
                        <div style="display: flex;justify-content: center;">
                        <table width="70%" height="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                        
                            <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align:center;font-size: 25px;font-weight: 500;">View Doctor Details</p><br><br>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2" style="color: gray;font-weight: 550;">
                                    '.$name.'<br><br>
                                </td>
                            ...
                            <tr>
                                ...
                                <div style="text-align: center;">
                                    <a href="settings.php"><input type="button" value="OK" class="login-btn btn-primary-soft btn" style="width:250px;"></a>
            ...
            if($error_1!='4'){
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <div style="display: flex;justify-content: center;">
                                <div class="abc">
                                <table width="80%" height="50%" class="sub-table scrolldown add-doc-form-container" border="0">
                                <tr>
                                        <td class="label-td" colspan="2">'.
                                            $errorlist[$error_1]
                                        .'</td>
                                    ...
                                    <tr>
                                        <td style="text-align: center;">
                                            <p style="padding: 0;margin: 0;text-align:center;font-size: 25px;font-weight:500;">Edit Doctor Details</p>
                                        Doctor ID : '.$id.' <br><br>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <label for="spec" class="form-label">Choose specialty</label>
                                ...
                                echo     '       </select><br><br>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <input type="reset" value="Reset" class="login-btn btn-primary-soft btn" style="width: 250px;margin-right: 10px;">
                                        
                                            <input type="submit" value="Save" class="login-btn btn-primary btn" style="width: 250px;">
                                        </td>
